...
mod circuits {
    ...
    pub fn withdraw(
        ...
        (current_encrypted.owner.from_arcis(final_collateral), approved_u8.reveal(), amount_out.reveal())
    }
    ...
    pub fn borrow(
        ...
        (current_debt.owner.from_arcis(final_debt), approved_u8.reveal(), amount_out.reveal())
    }
