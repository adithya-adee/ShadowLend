 ...
 */
export type CompDefType = "deposit" | "borrow" | "withdraw" | "repay" | "spend" | "liquidate";
...
export async function buildInitCompDefInstruction(
  ...
  switch (type) {
    case "deposit":
      return await program.methods.init_deposit_comp_def().accounts(accounts).instruction();
    case "borrow":
      return await program.methods.init_borrow_comp_def().accounts(accounts).instruction();
    case "withdraw":
      return await program.methods.init_withdraw_comp_def().accounts(accounts).instruction();
    case "repay":
      return await program.methods.init_repay_comp_def().accounts(accounts).instruction();
    case "spend":
      return await program.methods.init_spend_comp_def().accounts(accounts).instruction();
    case "liquidate":
      return await program.methods.init_liquidate_comp_def().accounts(accounts).instruction();
    default:
